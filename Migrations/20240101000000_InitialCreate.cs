    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false).Annotation("Sqlite:Autoincrement", true),
                    FoodName = table.Column<string>(type: "TEXT", maxLength: 150, nullable: false),
                    Description = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
                    Quantity = table.Column<int>(type: "INTEGER", nullable: false),
                    Unit = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false, defaultValue: "servings"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey("FK_FoodListings_AspNetUsers_DonorId", x => x.DonorId, "AspNetUsers", "Id", onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
                    FoodListingId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Orders", x => x.Id);
                    table.ForeignKey("FK_Orders_AspNetUsers_UserId", x => x.UserId, "AspNetUsers", "Id", onDelete: ReferentialAction.Restrict);
                    table.ForeignKey("FK_Orders_FoodListings_FoodListingId", x => x.FoodListingId, "FoodListings", "Id", onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex("IX_FoodListings_DonorId", "FoodListings", "DonorId");
            migrationBuilder.CreateIndex("IX_FoodListings_ExpirationDate", "FoodListings", "ExpirationDate");
            migrationBuilder.CreateIndex("IX_FoodListings_Status", "FoodListings", "Status");
            migrationBuilder.CreateIndex("IX_Orders_FoodListingId", "Orders", "FoodListingId");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable("FoodListings");
